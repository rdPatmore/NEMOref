...
!      INTEGER         , INTENT(out) ::   nn_kperio       ! lateral global domain b.c. 
      INTEGER         , INTENT(out) ::   kperio       ! lateral global domain b.c. 
      !
      INTEGER ::   ios   ! Local integer
      !!
      NAMELIST/namusr_def/ nn_GYRE, ln_bench, jpkglo, kperio, dx, dy
      !!----------------------------------------------------------------------
      !
...
902   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namusr_def in configuration namelist' )
      ...
      kk_cfg = nn_GYRE
      !
      kpi = 36 * nn_GYRE + 2        ! Global Domain size
      kpj = 36 * nn_GYRE + 2
#if defined key_agrif
...
!      IF ( periodic ) THEN
!         kperio = 7                    ! GYRE configuration : closed domain
!      ELSE 
!         kperio = 0
!      ENDIF
      !
